...
/**
 * Ext.ux.ColorPicker2 Extension Class for ExtJs 2.0
 *
 * @author Amon
 * @version 2.0
 *
 ...
 */
Ext.ux.ColorPicker2 = function( config ) {
	config.bodyStyle = {'padding':'3px'};
	Ext.ux.ColorPicker2.superclass.constructor.call( this, config );
	this.initialize( config );
}
// extend Ext.ux.ColorPicker2 with Ext.util.Observable
Ext.extend(Ext.ux.ColorPicker2, Ext.util.Observable, {
...
Ext.applyIf( Ext.ux.ColorPanel.prototype, Ext.ux.ColorPicker2.prototype );
/**
 ...
 * @cfg {Object} captions labels of inputs (defaults to { red: 'R', green: 'G', blue: 'B', hue: 'H°', saturation: 'S%', brightness: 'V%', hexa: 'Color', websafe: 'Websafe' })
 */
Ext.ux.ColorDialog2 = function( config ) {
	this.config = config;
	this.config.resizable = false;
	this.config.renderTo = this.config.renderTo || Ext.DomHelper.append( document.body, {}, true );
	Ext.ux.ColorDialog2.superclass.constructor.call( this, config );
	this.domElement = Ext.get( this.config.renderTo );
	this.render( this.domElement );
	this.config.renderTo = this.body;
	this.initialize( this.config );
...
Ext.extend( Ext.ux.ColorDialog2, Ext.Window );
Ext.applyIf( Ext.ux.ColorDialog2.prototype, Ext.ux.ColorPicker2.prototype );